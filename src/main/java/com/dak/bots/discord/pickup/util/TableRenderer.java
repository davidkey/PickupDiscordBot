package com.dak.bots.discord.pickup.util;
...
/**
 * Stolen shamelessly from https://github.com/ekgame/storasbot/blob/master/src/main/java/lt/ekgame/storasbot/utils/TableRenderer.java
 * @author David
 *
 */
